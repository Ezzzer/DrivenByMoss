 ...
 */
public class StopArrCommand extends AbstractTrackCommand
{
    /**
     * Constructor.
     *
     ...
     */
    public StopArrCommand(final IModel model, final LaunchpadControlSurface surface)
    {
        super (model, surface);
    }
    ...
    public void execute (final ButtonEvent event, final int velocity)
    {
        ...
        this.onModeButton (event, Modes.STOP_ARR, "Stop Arr");
    }
}
